...
export default function Signin() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <h1 className='text-3xl text-center font-semiboldm my-7'>Signin</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 '>
        ...
        <button disabled = {loading} className='uppercase bg-slate-700 text-white rounded-lg p-3 hover:opacity-85 disabled:opacity-95'>{loading ? 'LOADING...' : 'Sign in'}</button>
      </form>
